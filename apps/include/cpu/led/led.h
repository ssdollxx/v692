...
#define LED_PORTX               JL_PORTB
#define LED_BLUE                  BIT(5)
...
#define LED_INIT_EN()     	    do{LED_PORTX->PU &= ~LED_RED;LED_PORTX->PD &= ~LED_RED;LED_PORTX->DIR &= ~LED_RED;}while(0)
#define LED_INIT_DIS()		    do{LED_PORTX->PU &= ~LED_RED;LED_PORTX->PD &= ~LED_RED;LED_PORTX->DIR |=  LED_RED;}while(0)
#define B_LED_ON()
#define B_LED_OFF()
